...
Usage:
    python3 tools/python/razer_ble.py --help
    python3 tools/python/razer_ble.py            # Show current settings
    python3 tools/python/razer_ble.py --single-dpi 1600        # Set one fixed DPI stage
    python3 tools/python/razer_ble.py --stages 800,1600,3200   # Set staged DPI profile
