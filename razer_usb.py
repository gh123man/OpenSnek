...
Usage:
    python razer_usb.py                          # Show current settings
    python razer_usb.py --dpi 1600               # Set current DPI
    python razer_usb.py --stages 400,800,1600    # Set DPI stages
    python razer_usb.py --active-stage 2         # Set active stage (1-5)
    python razer_usb.py --poll-rate 1000         # Set poll rate (125/500/1000)
"""
...
Note: This script targets USB and 2.4GHz dongle transport.
        """
    )
