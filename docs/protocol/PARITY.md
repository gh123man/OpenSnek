...
- scoped profile CRUD excludes automatic profile allocation, advanced profile surfaces, and profile-button remap writes; product implementation still needs transaction/readback integration before exposing these operations in UI
