...
- Basilisk V3 Pro Bluetooth Windows Synapse captures now show research-only profile/projection traffic on `01 86 00 00`, `01 82 00 00`, `01 8C <slot> 00`, `08 05 <slot> 00`, `08 06 01 00`, and `08 07 <slot> 00`; see [BLE Profile CRUD Draft](./BLE_PROFILE_CRUD_SPEC.md) and [Basilisk V3 Pro BT Extended Notes](../research/BASILISK_V3_PRO_BT_EXTENDED.md)
...
Observed passive frame shapes in the existing Python HID sniff path and live macOS `IOHIDDeviceRegisterInputReportCallback` captures on the Basilisk V3 X HyperSpeed / Basilisk V3 Pro Bluetooth paths:
