...
- Basilisk V3 Pro USB static lighting in the app now exposes all 12 addressable LEDs through the custom-frame path, persists the per-cell color frame, and restores it on reconnect when OpenSnek-owned settings restore is enabled.
