...
- Fixed Advanced USB software-lighting streams so volatile Custom Frame effects are periodically reasserted and recover when USB reachability returns after mouse sleep or power-cycle events.
