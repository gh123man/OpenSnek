...
- The macOS `Load` and `Store` popovers now use full-row hit targets, and saved local profiles are collapsed into a dropdown inside `Load` instead of expanding the popover vertically forever.
