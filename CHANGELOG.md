...
- The Lighting card now opens collapsed with a mode-only summary, uses onboard colors again after Advanced effects stop, and can be expanded to edit onboard or Advanced controls.
