...
final class DevicePreferenceStoreTests: XCTestCase {
    func testOpenSnekButtonProfileLibrarySupportsSaveUpdateAndDelete() {
        ...
        let saved = store.saveOpenSnekButtonProfile(name: "Travel", bindings: [4: ButtonBindingDraft(kind: .keyboardSimple, hidKey: 9, turboEnabled: false, turboRate: 0x8E)])
        ...
        let updated = store.updateOpenSnekButtonProfile(id: saved.id, name: "Travel 2", bindings: [4: ButtonBindingDraft(kind: .mouseForward, hidKey: 4, turboEnabled: false, turboRate: 0x8E)])
    ...
    func testOpenSnekLocalProfileLibrarySupportsCreateCopyRenameAndDelete() {
        ...
        let content = OpenSnekLocalProfileContent(
            dpi: OnboardDPIProfileSnapshot(scalar: DpiPair(x: 800, y: 800), activeStage: 0, pairs: [DpiPair(x: 800, y: 800), DpiPair(x: 1600, y: 1600)]), buttonBindings: [4: ButtonBindingDraft(kind: .mouseForward, hidKey: 4, turboEnabled: false, turboRate: 0x8E)], brightnessByLEDID: [1: 72],
            staticColorByLEDID: [1: RGBPatch(r: 10, g: 20, b: 30)], scrollMode: 1, scrollAcceleration: true, scrollSmartReel: false)
    ...
    func testOpenSnekLocalProfileLibraryMigratesButtonOnlyProfilesOnce() {
        ...
        let store = DevicePreferenceStore(defaults: defaults)
        let legacy = store.saveOpenSnekButtonProfile(name: "Legacy Buttons", bindings: [5: ButtonBindingDraft(kind: .keyboardSimple, hidKey: 80, turboEnabled: false, turboRate: 0x8E)])
    ...
    func testOpenSnekLocalProfileUpsertByOnboardUUIDPreservesLocalRecordID() {
        ...
        let store = DevicePreferenceStore(defaults: defaults)
        let device = MouseDevice(id: "usb-local-uuid-upsert", vendor_id: 0x1532, product_id: 0x00AB, product_name: "Basilisk V3 Pro", transport: .usb, path_b64: "", serial: "LOCAL-UUID-UPSERT", firmware: nil, profile_id: .basiliskV3Pro)
        let onboardIdentifier = UUID()
        let firstSnapshot = OnboardProfileSnapshot(
            profileID: 2, metadata: OnboardProfileMetadata(identifier: onboardIdentifier, name: "Desk"), dpi: OnboardDPIProfileSnapshot(scalar: DpiPair(x: 800, y: 800), activeStage: 0, pairs: [DpiPair(x: 800, y: 800)]),
            buttonBindings: [4: ButtonBindingDraft(kind: .mouseForward, hidKey: 4, turboEnabled: false, turboRate: 0x8E)], brightnessByLEDID: [1: 64], staticColorByLEDID: [1: RGBPatch(r: 1, g: 2, b: 3)], scrollMode: 0, scrollAcceleration: false, scrollSmartReel: true)
        let updatedSnapshot = OnboardProfileSnapshot(
            profileID: 2, metadata: OnboardProfileMetadata(identifier: onboardIdentifier, name: "Desk Edited"), dpi: OnboardDPIProfileSnapshot(scalar: DpiPair(x: 1600, y: 1600), activeStage: 1, pairs: [DpiPair(x: 800, y: 800), DpiPair(x: 1600, y: 1600)]),
            buttonBindings: [4: ButtonBindingDraft(kind: .keyboardSimple, hidKey: 80, turboEnabled: true, turboRate: 75)], brightnessByLEDID: [1: 128], staticColorByLEDID: [1: RGBPatch(r: 9, g: 8, b: 7)], scrollMode: 1, scrollAcceleration: true, scrollSmartReel: false)
    ...
    func testOpenSnekLocalProfileUpsertBySyntheticSlotKeyPreservesLocalRecordID() {
        ...
        let store = DevicePreferenceStore(defaults: defaults)
        let device = MouseDevice(id: "bt-local-synthetic-upsert", vendor_id: 0x068E, product_id: 0x00BA, product_name: "Basilisk V3 X HyperSpeed", transport: .bluetooth, path_b64: "", serial: "LOCAL-SYNTHETIC-UPSERT", firmware: nil, profile_id: .basiliskV3XHyperspeed)
        ...
        let first = store.upsertOpenSnekLocalProfile(
            name: "This Mouse", content: OpenSnekLocalProfileContent(dpi: OnboardDPIProfileSnapshot(scalar: DpiPair(x: 800, y: 800), activeStage: 0, pairs: [DpiPair(x: 800, y: 800)]), brightnessByLEDID: [1: 999], scrollMode: 7), syntheticSourceKey: sourceKey, device: device)
        let updated = store.upsertOpenSnekLocalProfile(
            name: "This Mouse Edited",
            content: OpenSnekLocalProfileContent(dpi: OnboardDPIProfileSnapshot(scalar: DpiPair(x: 1200, y: 1200), activeStage: 0, pairs: [DpiPair(x: 1200, y: 1200)]), buttonBindings: [5: ButtonBindingDraft(kind: .mouseBack, hidKey: 4, turboEnabled: false, turboRate: 0x8E)]),
    ...
    func testHyperspeedSyntheticLocalProfileKeySurvivesSerialChanges() {
        ...
        let first = store.upsertOpenSnekLocalProfile(name: "This Mouse", content: OpenSnekLocalProfileContent(dpi: OnboardDPIProfileSnapshot(scalar: DpiPair(x: 800, y: 800), activeStage: 0, pairs: [DpiPair(x: 800, y: 800)])), syntheticSourceKey: firstKey, device: firstDevice)
        let updated = store.upsertOpenSnekLocalProfile(name: "This Mouse", content: OpenSnekLocalProfileContent(dpi: OnboardDPIProfileSnapshot(scalar: DpiPair(x: 1200, y: 1200), activeStage: 0, pairs: [DpiPair(x: 1200, y: 1200)])), syntheticSourceKey: reconnectedKey, device: reconnectedDevice)
        let profiles = store.loadOpenSnekLocalProfiles()
    ...
    func testButtonBindingPersistencePreservesNonTextKeyboardHidKeys() {
        ...
        store.persistButtonBinding(ButtonBindingPatch(slot: 5, kind: .keyboardSimple, hidKey: 80, turboEnabled: false, turboRate: nil), device: device, profile: 1)
        store.persistButtonBinding(ButtonBindingPatch(slot: 4, kind: .keyboardSimple, hidKey: 224, turboEnabled: true, turboRate: 75), device: device, profile: 1)
    ...
    func test35KTopDPIButtonPersistsSemanticDefaultAsDefaultKind() {
        ...
        let store = DevicePreferenceStore(defaults: defaults)
        let device = MouseDevice(
            id: "usb-35k", vendor_id: 0x1532, product_id: 0x00CB, product_name: "Basilisk V3 35K", transport: .usb, path_b64: "", serial: nil, firmware: nil, profile_id: .basiliskV335K, button_layout: DeviceProfiles.resolve(vendorID: 0x1532, productID: 0x00CB, transport: .usb)?.buttonLayout)

        store.persistButtonBinding(ButtonBindingPatch(slot: 96, kind: .dpiCycle, hidKey: nil, turboEnabled: false, turboRate: nil), device: device, profile: 1)
    ...
    func testConnectBehaviorPersistsPerDevice() {
        ...
        let store = DevicePreferenceStore(defaults: defaults)
        let device = MouseDevice(id: "usb-connect-behavior", vendor_id: 0x1532, product_id: 0x00AB, product_name: "Basilisk V3 Pro", transport: .usb, path_b64: "", serial: "CONNECT-BEHAVIOR", firmware: nil, profile_id: .basiliskV3Pro)
    ...
    func testSelectedLocalProfileIDPersistsPerDevice() {
        ...
        let store = DevicePreferenceStore(defaults: defaults)
        let device = MouseDevice(id: "bt-selected-local-profile", vendor_id: 0x1532, product_id: 0x00BA, product_name: "Basilisk V3 X HyperSpeed", transport: .bluetooth, path_b64: "", serial: "SELECTED-LOCAL-PROFILE", firmware: nil, profile_id: .basiliskV3XHyperspeed)
        let profileID = UUID()
    ...
    func testDeviceSettingsSnapshotRoundTrips() {
        ...
        let store = DevicePreferenceStore(defaults: defaults)
        let device = MouseDevice(id: "usb-settings-snapshot", vendor_id: 0x1532, product_id: 0x00AB, product_name: "Basilisk V3 Pro", transport: .usb, path_b64: "", serial: "SETTINGS-SNAPSHOT", firmware: nil, profile_id: .basiliskV3Pro)
        let snapshot = PersistedDeviceSettingsSnapshot(
            stageCount: 3, stageValues: [800, 1600, 3200], stagePairs: [DpiPair(x: 800, y: 800), DpiPair(x: 1600, y: 1600), DpiPair(x: 3200, y: 3200)], activeStage: 2, pollRate: 500, sleepTimeout: 420, lowBatteryThresholdRaw: 0x24, scrollMode: 1, scrollAcceleration: true, scrollSmartReel: false,
            ledBrightness: 77, primaryLightingColor: RGBColor(r: 10, g: 20, b: 30), lightingEffect: LightingEffectPatch(kind: .wave, primary: RGBPatch(r: 10, g: 20, b: 30), waveDirection: .right), usbLightingZoneID: "logo",
            buttonBindings: [5: ButtonBindingDraft(kind: .keyboardSimple, hidKey: 80, turboEnabled: false, turboRate: 0x8E, clutchDPI: nil)])
    ...
    func testDisabledSettingStoragePreservesPreviouslyStoredDeviceState() {
        ...
        let store = DevicePreferenceStore(defaults: defaults)
        let device = MouseDevice(
            id: "usb-storage-gated-device", vendor_id: 0x1532, product_id: 0x00AB, product_name: "Basilisk V3 Pro", transport: .usb, path_b64: "", serial: "STORAGE-GATED", firmware: nil, profile_id: .basiliskV3Pro,
            button_layout: DeviceProfiles.resolve(vendorID: 0x1532, productID: 0x00AB, transport: .usb)?.buttonLayout)

        let storedSnapshot = PersistedDeviceSettingsSnapshot(
            stageCount: 3, stageValues: [800, 1600, 3200], stagePairs: [DpiPair(x: 800, y: 800), DpiPair(x: 1600, y: 1600), DpiPair(x: 3200, y: 3200)], activeStage: 2, pollRate: 500, sleepTimeout: 420, lowBatteryThresholdRaw: 0x24, scrollMode: 1, scrollAcceleration: true, scrollSmartReel: false,
            ledBrightness: 77, primaryLightingColor: RGBColor(r: 10, g: 20, b: 30), lightingEffect: nil, usbLightingZoneID: "logo", buttonBindings: [5: ButtonBindingDraft(kind: .keyboardSimple, hidKey: 80, turboEnabled: false, turboRate: 0x8E, clutchDPI: nil)])
        ...
        let storedSoftwareLightingRequest = SoftwareLightingEffectRequest(presetID: .cometChase, speed: 1.2, palette: [RGBPatch(r: 1, g: 2, b: 3), RGBPatch(r: 4, g: 5, b: 6)])
        store.persistSoftwareLightingApplyOnConnect(true, device: device)
        store.persistSoftwareLightingRequest(storedSoftwareLightingRequest, device: device)
        store.savePersistedButtonBindings(device: device, bindings: [5: ButtonBindingDraft(kind: .keyboardSimple, hidKey: 80, turboEnabled: false, turboRate: 0x8E, clutchDPI: nil)], profile: 1)
        ...
        let newSnapshot = PersistedDeviceSettingsSnapshot(
            stageCount: 2, stageValues: [400, 6400], stagePairs: [DpiPair(x: 400, y: 400), DpiPair(x: 6400, y: 6400)], activeStage: 1, pollRate: 1000, sleepTimeout: 300, lowBatteryThresholdRaw: 0x18, scrollMode: 0, scrollAcceleration: false, scrollSmartReel: true, ledBrightness: 20,
            primaryLightingColor: RGBColor(r: 200, g: 210, b: 220), lightingEffect: LightingEffectPatch(kind: .wave, primary: RGBPatch(r: 200, g: 210, b: 220), waveDirection: .right), usbLightingZoneID: "scroll_wheel",
            buttonBindings: [5: ButtonBindingDraft(kind: .mouseForward, hidKey: 4, turboEnabled: false, turboRate: 0x8E, clutchDPI: nil)])
        ...
        store.persistSoftwareLightingRequest(SoftwareLightingEffectRequest(presetID: .aurora, speed: 0.4), device: device)
        store.savePersistedButtonBindings(device: device, bindings: [5: ButtonBindingDraft(kind: .mouseForward, hidKey: 4, turboEnabled: false, turboRate: 0x8E, clutchDPI: nil)], profile: 1)
...
private func makeHyperspeedLocalProfileDevice(serial: String) -> MouseDevice {
    MouseDevice(id: "bt-local-synthetic-\(serial)", vendor_id: 0x068E, product_id: 0x00BA, product_name: "Basilisk V3 X HyperSpeed", transport: .bluetooth, path_b64: "", serial: serial, firmware: nil, profile_id: .basiliskV3XHyperspeed)
}
