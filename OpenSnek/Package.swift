...
let package = Package(
    ...
    ], dependencies: [.package(url: "https://github.com/SimplyDanny/SwiftLintPlugins", exact: "0.63.3"), .package(url: "https://github.com/sparkle-project/Sparkle", exact: "2.9.3")],
    targets: [
        ...
        .executableTarget(name: "OpenSnek", dependencies: ["OpenSnekCore", "OpenSnekProtocols", "OpenSnekHardware", "OpenSnekAppSupport", "Sparkle"], path: "Sources/OpenSnek", swiftSettings: swiftCompilerDiagnostics, plugins: swiftQualityBuildPlugins),
