...
final class AppStateDeviceController {
    ...
    var optionalEditorController: AppStateEditorController? {
        _editorController.optionalValue
    }

    var optionalApplyController: AppStateApplyController? {
        _applyController.optionalValue
    }

    var optionalRuntimeController: AppStateRuntimeController? {
        _runtimeController.optionalValue
    }
    ...
    func isRestoringSettings(for device: MouseDevice) -> Bool {
        !deviceIDsSharingIdentity(with: device).isDisjoint(with: restoringSettingsDeviceIDs)
    }

    func settingsRestoreRevision(for device: MouseDevice) -> Int {
    ...
    func bumpSettingsRestoreRevision(for device: MouseDevice) {
