...
@MainActor final class AppEnvironment {
    ...
    init(
        ...
        serviceCoordinator: BackgroundServiceCoordinator, softwareUpdateInstaller: any SoftwareUpdateInstalling = DisabledSoftwareUpdateInstaller.shared
    ) {
        self.launchRole = launchRole
        self.releaseUpdateChecker = releaseUpdateChecker
        self.softwareUpdateInstaller = softwareUpdateInstaller
